    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if(!empty($model->imageFile)){
                $path = Yii::$app->params['base_dir'] . '/uploads/options/';
                $_file_name = $model->imageFile->baseName.'.'.$model->imageFile->extension;
                $model->imageFile->saveAs($path.$_file_name);
                $model->value = $_file_name;
            }
        }
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
